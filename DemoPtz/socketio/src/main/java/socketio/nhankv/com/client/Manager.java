...
import socketio.nhankv.com.backo.Backoff;
import socketio.nhankv.com.emitter.Emitter;
import socketio.nhankv.com.parser.IOParser;
import socketio.nhankv.com.parser.Packet;
import socketio.nhankv.com.parser.Parser;
import socketio.nhankv.com.thread.EventThread;
...
public class Manager extends Emitter {
    ...
    /*package*/ socketio.nhankv.com.engineio.client.Socket engine;
    ...
    public Manager open(final OpenCallback fn) {
        EventThread.exec(new Runnable() {
            ...
            public void run() {
                ...
                final socketio.nhankv.com.engineio.client.Socket socket = Manager.this.engine;
    ...
    private void onopen() {
        ...
        final socketio.nhankv.com.engineio.client.Socket socket = this.engine;
    ...
    private static class Engine extends socketio.nhankv.com.engineio.client.Socket {
    ...
    public static class Options extends socketio.nhankv.com.engineio.client.Socket.Options {
